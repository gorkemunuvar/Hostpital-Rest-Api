...
def set_api():
    ...
    api.add_resource(PolyclinicsByHospitalId, '/api/polyclinics_by_hospital_id/<string:hospital_id>')
    api.add_resource(SearchPolyclinic, '/api/polyclinics/search/<string:search_text>')
