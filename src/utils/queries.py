...
GET_POLYCLINICS = "select profs,isim from ng_his_kabuzman where kiosk='X'order by isim"

# | KABINET | ISIM        | SINIFI |
# | 69062   | 208 DAHLIYE | P      |

GET_PROFESSIONS_BY_POLYCLINIC_ID = "select KABINET,ISIM,SINIFI from ng_his_glzr WHERE PROFS='{polyclinic_id}'"


# | DOKTOR_ID | AD   | SOYAD |
# | DR582   | Yildiz | Ayse  |

GET_DOCTORS_BY_PROFESSION_ID = """SELECT doktor_id,soy,ad from ng_his_vrtkmad
...
GET_AVAILABLE_APPOINTMENT_DATES = """select ng_his_vractakvim.datar, 'прием' d, ng_his_vractakvim.bassaat,
...
GET_AVAILABLE_APPOINTMENT_TIME_REQUIREMENTS = """select ng_his_vractakvim.datar, 'прием' d, 
...
GET_AVAILABLE_APPOINTMENT_TIMES = """select  SIRA_NO, XDAKKIKA 
                                     from ng_his_ransaat 
